  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-6xl mx-auto">
        ...
        <button
          onClick={login}
          className="px-4 py-2 rounded-lg bg-vanto-600 text-white text-sm font-medium hover:bg-vanto-700 transition-colors"
        >
          Get Started
        </button>
      </nav>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
          <button
            onClick={login}
            className="flex items-center gap-2 px-6 py-3 rounded-xl bg-vanto-600 text-white font-medium hover:bg-vanto-700 transition-colors"
          >
      ...
      {/* CTA */}
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="rounded-2xl bg-vanto-600 p-12 text-center text-white">
